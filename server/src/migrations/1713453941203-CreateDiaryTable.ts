...
export class CreateDiaryTable1713453941203 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "diary" ADD CONSTRAINT "FK_bda48d3f2d272ca20f3aa612e5c" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
